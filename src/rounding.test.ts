...
// NOTE: the targetDigits parameter is the TOTAL number of significant digits to
// keep, including the integer part (e.g. the leading "1" of a normalized "1.xxxx"
// mantissa). For a 1-digit integer part, targetDigits = fractionalDigitsKept + 1.
describe('demonstrateRoundingMethods', () => {
  describe('PS Question 1: -1.86855, decimal rounding', () => {
    describe('a) 4 decimal digits (3 fractional digits kept)', () => {
      const res = demonstrateRoundingMethods('-1.86855', false, 4);
  ...
  describe('PS Question 2: -1.011100, binary rounding', () => {
    describe('a) 4 binary digits (3 fractional bits kept)', () => {
      const res = demonstrateRoundingMethods('-1.011100', true, 4);
